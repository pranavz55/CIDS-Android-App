...
public class Upload_Missing extends AppCompatActivity implements View.OnClickListener{

    private static final int PICK_IMAGE_REQUEST = 1;
    private Button mButtonChooseImage;
    private Button mButtonUpload;
    private TextView mTextViewShowUploads;
    private EditText Name,desc,last_seen,reason,contact,contact_2,gender,dob,height;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__missing);
        ...
        contact_2= findViewById(R.id.m_contactnew);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("missings");
    ...
    Missing missing= new Missing(downloadUri.toString(),Name.getText().toString().trim(),dob.getText().toString().trim(),
                                gender.getText().toString().trim(),last_seen.getText().toString().trim(),reason.getText().toString().trim(),desc.getText().toString().trim(),
                                height.getText().toString().trim(),contact.getText().toString().trim(),contact_2.getText().toString().trim());

                        String uploadId = mDatabaseRef.push().getKey();
                        mDatabaseRef.child(uploadId).setValue(missing);
                ...
                public void onSuccess(Object o) {
                    mprogressDialog = new ProgressDialog(Upload_Missing.this);
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(this, image_missing.class);
