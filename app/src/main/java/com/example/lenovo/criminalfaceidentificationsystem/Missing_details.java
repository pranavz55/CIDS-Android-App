...
*/
    ...
    public void onSend(){
        ...
        if (ActivityCompat.checkSelfPermission(com.example.lenovo.criminalfaceidentificationsystem.Missing_details.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED ) {

            return;
        }

        client.getLastLocation().addOnSuccessListener(com.example.lenovo.criminalfaceidentificationsystem.Missing_details.this, new OnSuccessListener<Location>() {
            @Override
            public void onSuccess(Location location) {

                if(location!= null){//Toast.makeText(MainActivity.this, "sadsd", Toast.LENGTH_SHORT).show();
                    loc = location.toString();
                    Toast.makeText(com.example.lenovo.criminalfaceidentificationsystem.Missing_details.this, ""+loc, Toast.LENGTH_LONG).show();
