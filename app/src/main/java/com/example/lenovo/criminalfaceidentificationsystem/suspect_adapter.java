...
public class suspect_adapter extends RecyclerView.Adapter<suspect_adapter.ImageViewHolder> {

    private Context mContext;
    //private List<Upload> mUploads;
    private List<Infosuspect> mUploads;

    public suspect_adapter(Context context, List<Infosuspect> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public void onBindViewHolder(@NonNull final ImageViewHolder imageViewHolder, final int position) {
        ...
        final Infosuspect missingCurrent = mUploads.get(position);
        ...
        imageViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext,Suspect_details2.class);
